      ...
      >
        ...
        >
          <defs>
            ...
            <linearGradient id="ar_neon" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          {/* Stylized aerodynamic sports car roofline */}
          <path
            d="M 15 62 C 28 58, 40 48, 54 34 C 68 20, 92 18, 114 26 C 132 32, 142 45, 148 58"
            stroke="url(#ar_chrome)"
            strokeWidth="5"
            strokeLinecap="round"
          />

          {/* Underbody neon glow stream */}
          <path
            d="M 12 66 L 148 66"
            stroke="url(#ar_neon)"
            strokeWidth="3.5"
          ...
          {/* Wheel well arches */}
          <circle cx="38" cy="66" r="10" stroke="url(#ar_chrome)" strokeWidth="3" />
          <circle cx="122" cy="66" r="10" stroke="url(#ar_chrome)" strokeWidth="3" />

          {/* Plate box in center */}
          <rect x="52" y="58" width="56" height="15" rx="3" fill="#020D08" stroke="#10B981" strokeWidth="1.5" />
          <text
            x="80"
            y="69"
            fill="#FFFFFF"
